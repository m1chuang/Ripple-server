...
test.route("/cleardb").post(function (req, res) {
...
test.route("/initdb").post(function (req, res) {});
test.route("/pub").post(function (req, res) {
    console.log("pubb");
...
test.route("/sub").post(function (req, res) {
    console.log("pubb");
