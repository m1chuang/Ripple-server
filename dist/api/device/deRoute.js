...
device.route("/friend/delete").post(function (req, res) {
    var params = {
        my_device_id: req.body.device_id,
        target_mid: req.body.target_id
    };
    DeviceCtr.unFriend(params, function (err, status) {
        res.json({
            status: status
        });
    });
...
device.route("/friend/add").post(function (req, res) {
    var params = {
        my_device_id: req.body.device_id,
        target_mid: req.body.target_id
    };
...
.post(function (req, res) {
    ...
    DeviceCtr.getPageExplore(params, function (err, explore_list) {
